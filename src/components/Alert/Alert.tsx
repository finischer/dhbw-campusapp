...
const Alert = React.forwardRef<IAlertFunctions, IAlertProps>(
  ({ title, description, pressBackdropToClose = true, buttons = [] }, ref) => {
    ...
    return (
      <Dialog.Container
        ...
        onBackdropPress={pressBackdropToClose ? closeAlert : undefined}
        visible={visible}
