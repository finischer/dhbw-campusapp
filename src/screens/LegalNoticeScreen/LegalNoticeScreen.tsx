...
const ContactRow = ({
  ...
  <View style={legalNoticeScreenStyles.contactRowContainer}>
    <Icon source="feather" clickable={false} name={iconName} size={16} />
    <RegularText style={legalNoticeScreenStyles.contactRowText}>
      {children}
    </RegularText>
  </View>
);
    ...
    <GlobalBody>
      <ScrollView>
        ...
        <Section title="Haftungsausschluss - Disclaimer">
          ...
          >
            ...
            <Subsection>
              <RegularText>
                ...
                eigenen Internetauftrittes „Name Ihrer Domain“ gesetzten Links
                ...
                haftet allein der Diensteanbieter der Seite, auf welche
          ...
          <Subsection title="Urheberrecht" withMarginTop={false}>
            <RegularText>
